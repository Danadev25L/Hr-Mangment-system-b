    ...
    <Row gutter={[16, 16]}>
      <Col xs={24} sm={12} lg={6}>
        <Card className="shadow-md hover:shadow-lg transition-shadow border-l-4 border-l-blue-500">
          <Statistic
            title={<span className="text-gray-600 font-medium">{t('totalApplicationsStat')}</span>}
            value={total}
      ...
      <Col xs={24} sm={12} lg={6}>
        <Card className="shadow-md hover:shadow-lg transition-shadow border-l-4 border-l-orange-500">
          <Statistic
            title={<span className="text-gray-600 font-medium">{t('pending')}</span>}
            value={pending}
      ...
      <Col xs={24} sm={12} lg={6}>
        <Card className="shadow-md hover:shadow-lg transition-shadow border-l-4 border-l-green-500">
          <Statistic
            title={<span className="text-gray-600 font-medium">{t('approved')}</span>}
            value={approved}
      ...
      <Col xs={24} sm={12} lg={6}>
        <Card className="shadow-md hover:shadow-lg transition-shadow border-l-4 border-l-red-500">
          <Statistic
            title={<span className="text-gray-600 font-medium">{t('rejected')}</span>}
            value={rejected}
